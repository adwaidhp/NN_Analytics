...
public:
    ...
    void set()
    {
        ...
        node_list = {
            {{ACT_FUN::leaky_relu, 2.0}, {ACT_FUN::leaky_relu, 3.0}, {ACT_FUN::leaky_relu, 2.0}},

            {{ACT_FUN::leaky_relu, 2.0}, {ACT_FUN::leaky_relu, 2.0}, {ACT_FUN::leaky_relu, 2.0}},

            {{ACT_FUN::leaky_relu, 3.0}, {ACT_FUN::leaky_relu, 2.0}, {ACT_FUN::leaky_relu, 4.0}}};
